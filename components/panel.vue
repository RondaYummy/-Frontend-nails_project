...
export default {
  head() {
    return {
      ...
      script: [
        { hid: "stripe", src: "../assets/js/d3", defer: true },
        {
          hid: "stripe",
          src: "../assets/js/getmdl-select.min.js",
          defer: true,
        },
        { hid: "stripe", src: "../assets/js/material.js", defer: true },
        { hid: "stripe", src: "../assets/js/nv.d3.js", defer: true },
        { hid: "stripe", src: "../assets/js/layout/layout.js", defer: true },
        { hid: "stripe", src: "../assets/js/scroll/scroll.js", defer: true },
        {
          hid: "stripe",
          src: "../assets/js/widgets/charts/discreteBarChart.js",
          defer: true,
        },
        {
          hid: "stripe",
          src: "../assets/js/widgets/charts/linePlusBarChart.js",
          defer: true,
        },
        {
          hid: "stripe",
          src: "../assets/js/widgets/charts/stackedBarChart.js",
          defer: true,
        },
        {
          hid: "stripe",
          src: "../assets/js/widgets/employer-form/employer-form.js",
          defer: true,
        },
        {
          hid: "stripe",
          src: "../assets/js/widgets/line-chart/line-charts-nvd3.js",
          defer: true,
        },
        { hid: "stripe", src: "../assets/js/widgets/map/maps.js", defer: true },
        {
          hid: "stripe",
          src: "../assets/js/widgets/pie-chart/pie-charts-nvd3.js",
          defer: true,
        },
        {
          hid: "stripe",
          src: "../assets/js/widgets/table/table.js",
          defer: true,
        },
        {
          hid: "stripe",
          src: "../assets/js/widgets/todo/todo.js",
          defer: true,
        },
      ],
    };
...
<style scoped>
/* @import '~/assets/css/lib/getmdl-select.min.css';
@import '~/assets/css/lib/nv.d3.css'; */
